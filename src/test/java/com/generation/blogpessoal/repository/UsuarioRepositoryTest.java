...
public class UsuarioRepositoryTest {
	...
	void start() {
		...
		usuarioRepository.deleteAll();// deleteAll para apagar qualquer informção da tabela usuário
		...
		// vai ter criado esses 4 usuários
	}
	...
	public void deveRetornarUmUsuario() {
		...
		// Dar Run As para o JUnit verificar e fazer o teste.
	}
